...
const monstersList = [
  ...
  },
  {
    ...
    type: ['feu','terre'],
    faiblesses: ['eau', 'terre'],
    resistances: ['feu','plante','electric'],
    pointsDeVie: 90,
  ...
  },
  {
    ...
    nom: 'Carchateur',
    type: ['eau','electric'],
    faiblesses: ['terre', 'plante'],
    resistances: ['feu', 'eau','vol'],
    pointsDeVie: 90,
  ...
  },
  {
    id: 14,
    nom: 'Gloriole',
    type: ['plante','electric'],
    faiblesses: ['feu','terre'],
    resistances: ['plante', 'electric','eau'],
    pointsDeVie: 85,
